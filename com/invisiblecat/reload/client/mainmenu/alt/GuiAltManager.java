...
extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 2: {
                ...
                DevAltManager.registry.remove(this.selectedAlt);
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(fontRendererObj, sb2.append(DevAltManager.registry.size()).append(" alts").toString(), width / 2, 10, -1);
        this.drawCenteredString(this.fontRendererObj, this.loginThread == null ? this.status : this.loginThread.getStatus(), width / 2, 20, -1);
        Gui.drawRect((int) 50.0f, (int) 33.0f, width - 50, height - 50, -16777216);
        GL11.glPushMatrix();
        this.prepareScissorBox(0.0f, 33.0f, width, height - 50);
        GL11.glEnable(3089);
        int y2 = 38;
        for (Alt alt2 : DevAltManager.registry) {
