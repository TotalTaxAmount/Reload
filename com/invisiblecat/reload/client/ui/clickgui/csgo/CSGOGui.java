package com.invisiblecat.reload.client.ui.clickgui.csgo;

import java.io.IOException;
import java.util.ArrayList;

import com.invisiblecat.reload.client.ui.clickgui.csgo.buttons.CSCategoryButton;
...
public class CSGOGui extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		Gui.drawRect(this.x + 65, this.y, this.x + 67, this.height, HUD.getClientColor().getRGB());
		Gui.drawRect(this.x + 165, this.y, this.x + 167, this.height, HUD.getClientColor().getRGB());
