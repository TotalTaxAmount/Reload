package com.invisiblecat.reload.utils.font;
...
public final class CustomFontUtil {
    ...
    public static final Manager FONT_MANAGER = new Manager();

    private final TTFFontRenderer fontRendererSmall = FONT_MANAGER.getFont("Light 12");
    ...
    private final TTFFontRenderer fontRendererHuge = FONT_MANAGER.getFont("Light 60");
